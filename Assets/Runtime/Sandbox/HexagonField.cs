...
public class HexagonField : MonoBehaviour
{
    ...
    public HexagonTileFilter.Orientation        orientation         = HexagonTileFilter.Orientation.PointyTop;
    public HexagonTileFilter.CoordinateSystem   coordinateSystem    = HexagonTileFilter.CoordinateSystem.Offset;
    ...
    public HexagonTileFilter                    hexFilter           { get; private set; } = null;
    ...
    { 
        ...
        this.hexFilter          = new HexagonTileFilter(this.orientation, this.coordinateSystem, this.origin, this.scale);
    ...
    {   
        ...
        for(int z = 0; z < this.size.y; z++)
        {
            for(int x = 0; x < this.size.x; x++)
            {
                ...
                vertices.AddRange(this.hexFilter.computeCorners(coord, 0.0f, true));
                tileUVs.AddRange(this.hexFilter.unitCornerUvs);
    ...
    private void OnDrawGizmosSelected() 
    {
        ...
        for(int z = 0; z < this.size.y; z++)
        {
            for(int x = 0; x < this.size.x; x++)
            {
                ...
                var world = this.hexFilter.hex2world(coord + this.origin);
